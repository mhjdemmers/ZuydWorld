...
namespace ZuydWorld.Controllers
{
    public class GameController : Controller
    {
        ...
        public GameController(ZuydWorldContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Game != null ? 
                          ...
                          Problem("Entity set 'ZuydWorldContext.Game'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,GameName")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GameName")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
